...
const home = () => {
  const icons = [
    { title: "LinkedinIcon", id: "https://www.linkedin.com/feed/" },
    { title: "GitBranch", id: "https://github.com/hansrohit" },
    { title: "MailPlus", id: "hansrohit031@gmail.com" },
  ];
      ...
      <div className="h-screen w-full roboto-bold-italic flex flex-col justify-center items-center">
        <div className="text-white  justify-start flex items-center h-[80%] w-[95%]">
          <div className="flex flex-col animater justify-end items-start h-[90%] w-[60%]">
            ...
            <div className="h-[12%] flex justify-start items-center w-full font-extrabold text-xl">
              <span className="text-2xl font-extrabold text-cyan-400">
                MERN Stack Developer
              </span>
            </div>
            <div className="h-[40%] text-justify flex justify-center items-start w-full font-thin text-xl">
              A dedicated MERN stack developer specializing in building dynamic
              and responsive web applications using MongoDB, Express, React, and
              Node.js. I thrive on creating seamless user experiences and
              tackling complex challenges. I’m passionate about learning new
              technologies and constantly improving my skills. Open to
              collaborating on exciting projects and bringing innovative ideas
              to life!
            </div>
