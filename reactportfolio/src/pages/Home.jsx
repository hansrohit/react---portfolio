...
const home = () => {
  ...
  return (
    <>
     <div className='h-screen  quack w-full roboto-bold-italic flex flex-col justify-center items-center'>
      <div className='text-white justify-start flex items-center h-[80%] w-[95%]'>
        ...
        <div className='h-[90%] w-[40%]  flex justify-center items-center'>
          <div className='h-[85%] w-[75%] flex justify-center items-center border-none rounded-full'><img src={jinju} alt="" className='border-2 h-[100%] w-[100%] rounded-full border-none hover:animate-pulse' /></div>
        </div>
      </div>
     </div>
      {/* <Projects/> */}
