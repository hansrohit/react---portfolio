          ...
          <div className='h-full w-[95%] flex justify-center items-center'>
           ...
           <div className='flex justify-end items-center h-full w-[50%]'>
            <ul className='h-full w-full list-none flex flex-row justify-center gap-1 items-center font-semibold'>
                <li className='border-1  justify-center flex items-center h-[100%] w-[40%] hover:bg-slate-800 hover:bg-opacity-30 hover:text-white'>Home</li>
                <li className='border-1 justify-center flex items-center h-[100%] w-[40%] hover:bg-slate-800 hover:text-white hover:bg-opacity-30'>Project</li>
                <li className='border-1 justify-center flex items-center h-[100%] w-[40%] hover:bg-slate-800 hover:text-white hover:bg-opacity-30'>Contact</li>
