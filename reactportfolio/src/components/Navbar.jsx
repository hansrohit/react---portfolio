...
const Navbar = () => {
  ...
  return (
    <>
      <div className="bg-transparent bg-opacity-35 rounded-sm h-[4rem] w-full flex justify-around items-center sticky z-50 top-0">
        <div className="h-full w-[95%] flex justify-center items-center ">
          <div className="flex h-full w-full justify-start items-center text-gray-200 ">
          ...
          <div className="flex justify-end items-center h-full w-[50%]">
            <ul className="h-full w-full list-none flex flex-row justify-center gap-1 items-center font-semibold ">
              {navdata.map((data, index) => (
                ...
                >
                  <li className="border-2 rounded-lg border-transparent justify-center flex items-center text-zinc-100 h-full w-full hover:bg-opacity-30 transition hover:text-cyan-500">
                    {data.title}
                  </li>
                </NavLink>
              ))}
